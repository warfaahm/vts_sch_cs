                    ...
                    <Transition
                        ...
                        <Menu.Items className='absolute right-0 w-56 z-50 mt-2 origin-top-right bg-white rounded shadow-sm'>
                            <div className='p-1'>
                                ...
                                <Menu.Item>
                                    <button className='flex hover:bg-blue-600 hover:text-white text-gray-700 w-full rounded p-2 text-sm group transition-colors items-center' onClick={handleLogout}>
