...
export default function TopBarProvider({ showNav, setShowNav }) {
                ...
                <Menu as='div' className='relative inline-block text-left'>
                    ...
                    <Transition
                        ...
                        <Menu.Items className='absolute right-0 w-56 z-50 mt-2 origin-top-right bg-white rounded shadow-sm'>
                            <div className='p-1'>
                                <Menu.Item>
                                    <Link href='/provider/profile' className='flex hover:bg-blue-600 hover:text-white text-gray-700 rounded p-2 text-sm group transition-colors items-center'>
                                        <UserCircleIcon className='h-4 w-4 mr-2'/>
                                        <span>Profile</span>
                                    </Link>
                                </Menu.Item>
                                <Menu.Item>
                                    <button className='flex hover:bg-blue-600 hover:text-white w-full text-gray-700 rounded p-2 text-sm group transition-colors items-center' onClick={handleLogout}>
