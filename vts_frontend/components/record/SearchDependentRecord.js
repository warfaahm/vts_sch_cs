...
import SearchResultDependent from "@/components/record/SearchResultDependent";
import SearchPatientForm from "@/components/record/SearchPatientForm";


export default function SearchDependentRecord()
{
            ...
            <div>
                ...
                <div>
                    {userInfo?.name && userInfo?.number &&(
                        <SearchResultDependent name={userInfo?.name} number={userInfo?.number}/>
                    )}
                </div>
            </div>
            <Popup
