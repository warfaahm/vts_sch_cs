...
export default function ProviderReportVaccine()
{
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/staff/report/record2',
                {
                    year: "2023",
    ...
    return (
        <div className='bg-blue-100 rounded-lg m-2 p-2 max-w-xl'>
            <div><h1 className='p-2 flex justify-center font-bold'>Vaccine Year: 2023</h1></div>
