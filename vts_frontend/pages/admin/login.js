                ...
                <div className="h-screen flex items-center justify-center">
                    <div className="w-full max-w-md md:max-w-lg ">
                        ...
                        <div className="my-8 py-8 px-16 w-full shadow-2xl rounded-2xl">
                            <h1 className="font-bold text-2xl my-2">Admin Account</h1>
                            ...
                            <div className="flex justify-end my-4">
                                <Link href="/admin/reset" className="font-semibold underline underline-offset-2">Forgot your password?</Link>
                            </div>
                        </div>
                    </div>
                </div>
