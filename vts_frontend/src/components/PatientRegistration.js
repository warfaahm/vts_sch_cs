...
function PatientRegistration() {
    document.title = "Patient Registration | VTS";
    return (
                        ...
                        <form method="POST">
                            <div class="grid gap-4 mb-2 md:grid-cols-2">
                                <div className="mb-2 w-full">
                                    ...
                                    <input type="text" id="first_name" name="first_name" className="input_1" required/>
                                </div>
                                <div className="mb-2 w-full">
                                    <label  htmlFor="last_name" className="label_1">Last name</label>
                                    <input type="text" id="last_name" name="last_name" className="input_1" required/>
                                </div>
                                <div className="mb-2 w-full">
                                    <label htmlFor="id_no" className="label_1">ID Number</label>
                                    <input type="text" id="id_no" name="id_no" className="input_1" required/>
                                </div>
                                <div className="mb-2 w-full">
                                    <label  htmlFor="phone_no" className="label_1">Phone No</label>
                                    <input type="text" id="phone_no" name="phone_no" className="input_1" required/>
                                </div>
                            </div>
                            <div>
                                <h3 className="label_1">Gender</h3>
                                <div className="inline">
                                    <input type="radio" name="gender" id="gender" value="M" className="radio-form" required/>
                                    <label className="mx-2">Male</label>
                                </div>
                                <div className="inline m-4">
                                    <input type="radio" name="gender" id="gender" value="F" className="radio-form" required/>
                                    <label className="mx-2">Female</label>
                                </div>
                            </div>
                            <div className="my-4 w-full">
                                <label htmlFor="dob" className="label_1">Date of birth</label>
                                <input type="date" id="dob" name="dob" className="input_1" required/>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation" className="input_1" required/>
                            </div>
                            <div className="my-2">
                                <div className="inline">
